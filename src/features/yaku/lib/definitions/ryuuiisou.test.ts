...
describe("緑一色（リューイーソー）の判定", () => {
  ...
  it("全ての牌が緑色牌（23468s, 發）の場合、成立すること", () => {
    ...
    const hand = createMentsuStructureFromMspz("234s234s666s888s66z");
  ...
  it("發を含まない緑一色（純緑一色形）でも成立すること", () => {
    ...
    const hand = createMentsuStructureFromMspz("222s333s444s666s88s");
  ...
  it("副露していても成立すること", () => {
    ...
    const hand = createMentsuStructureFromMspz("234s666s66z[888s][234s]");
  ...
  it("緑色以外の牌が1枚でも含まれる場合は不成立", () => {
    ...
    const hand = createMentsuStructureFromMspz("234s234s666s888s11z");
  ...
  it("索子でも緑色でない牌（1,5,7,9）が含まれる場合は不成立", () => {
    ...
    const hand = createMentsuStructureFromMspz("234s666s888s66z555s");
